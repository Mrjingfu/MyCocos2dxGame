...
bool StarPopUpUI::init()
{
    ...
    m_popupBgLayer = cocos2d::ui::ImageView::create(UtilityHelper::getLocalString("UI_START_PANEL"),cocos2d::ui::TextureResType::PLIST);
    ...
    cocos2d::ui::ImageView* distanceView = cocos2d::ui::ImageView::create(UtilityHelper::getLocalString("UI_GAME_BEST_TV"),cocos2d::ui::TextureResType::PLIST);
    ...
    cocos2d::ui::Button* playBtn = cocos2d::ui::Button::create(UtilityHelper::getLocalString("UI_START_BTN_NEW"),"","",cocos2d::ui::TextureResType::PLIST);
    ...
    cocos2d::ui::Button* resumeBtn = cocos2d::ui::Button::create(UtilityHelper::getLocalString("UI_START_BTN_CONTINUE"),"","",cocos2d::ui::TextureResType::PLIST);
