...
SecondWeaponProperty* SecondWeaponProperty::clone() const
{
    SecondWeaponProperty* prop = new (std::nothrow) SecondWeaponProperty(PlayerProperty::m_snItemInstanceIDCounter++,this->m_ItemType,this->m_nLevel,this->m_bIdentified);
