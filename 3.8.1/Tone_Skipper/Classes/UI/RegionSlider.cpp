...
bool RegionSlider::hitTest(const cocos2d::Vec2 &pt, const cocos2d::Camera* camera, cocos2d::Vec3 *p) const
{
...
//    return false;
    ...
    cocos2d::Rect rect;
    rect.size = _slidBallNormalRenderer->getContentSize()+m_touchSize;
